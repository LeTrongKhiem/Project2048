...
public interface ViewInterface {
	 ...
	 * @throws IllegalArgumentException If width < 4 or width > 20 or height < 4 or
	 *                                  height > 20
	 */
	 ...
	 * 
	 * @param moves A list of all tiles to be moved; includes their past and present
	 ...
	 * 
	 * @param newTiles A list of all tiles to be added to the board; includes their
	 *                 positions and values.
	 */
	...
	/**
	 * Displays to the user the score of this game and the highScore of this
	 * session.
	 * 
