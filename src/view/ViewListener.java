...
/**
 * Listens for certain user actions in the Environment, primarily from the
 * keyboard, then sends those actions to the controller of this game.
 */
public class ViewListener extends KeyAdapter implements MouseListener, ActionListener, ItemListener, WindowListener {
	...
	/**
	 * Constructs this ViewListener and directs it to send all pertinent user input
	 * to the controller provided.
	 * 
	 * @param controller The controller that this ViewListener will send all
	 *                   pertinent user actions to.
	...
	/**
	 * Captures keyPressed events from the environment, interprets the events as
	 * movement directions or as a restart command, if possible, then communicates
	...
	/**
	 * Captures mousePressed events from the environment and saves its location on
	 * the screen.
	 * 
	...
	/**
	 * Captures mouseReleased events from the environment then communicates the
	 * direction moved between the last mousePressed event and this event to the
	 * controller, unless the distance between the two events is <= 20 px.
	 * 
	...
	/**
	 * Captures itemStateChanged events from JComboBoxes and saves their values
	 * until the next restart game event.
	 * 
