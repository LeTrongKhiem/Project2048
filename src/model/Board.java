...
public class Board implements Serializable {
	...
	/**
	 * Sets the value of the given cell, if contained on this board, to the value
	 * given.
	 * 
	 ...
	 * 
	 * @param isGameWon represents if this board is marked as won (true) or not
	 *                  (false)
	 */
	 ...
	 * Set state information about this board.
	 * 
	 * @param isGameOver represents if this board is marked as over (true) or not
	 *                   (false)
	 */
