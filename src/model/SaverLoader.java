...
/**
 * All static methods required to save, load, and delete board state
 * information.
 */
public class SaverLoader {
	 ...
	 * 
	 * @return The board retrieved from memory, null if no valid board save was
	 *         found.
	 */
	public static Board loadGame() {
		...
		try {
			...
			// file not found, or some other error... thus no game save available or broken
			// so return null
		}
		return board;
	}
