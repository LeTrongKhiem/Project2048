...
public interface ModelInterface {
	...
	/**
	 * Starts a new game from a saved file, if no file exists it starts a game with
	...
	/**
	 * Ends the current game. This attempts to save the current board to file, no
	 * errors are thrown if the save fails.
	 */
	public void endGame();
	...
	/**
	 * Indicates whether this game has been won or not. Note that to win the game
	 * the '2048' tile must be created, however the user can continue to play after
	 * that point.
	 * 
	...
	/**
	 * Indicates whether this game is over. For a game to be over, the board must be
	 * completely filled and no moves are available.
	 * 
