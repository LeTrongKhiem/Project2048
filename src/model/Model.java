...
/**
 * Manipulates the state of the board according to the rules of the game as well
 * as keeping track of the score, high score, and checks for victory conditions.
 */
public class Model implements ModelInterface {
	...
	public List<ATileMove> startGame(int width, int height) {
		...
		} catch (IllegalArgumentException e) { // if an exception is thrown due to bad width/height given, make the
												// default board
