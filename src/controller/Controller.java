...
/**
 * The entry point for the 2048 game, it contains the main method of the 2048
 * Game. This communicates user actions to the model then updates the view based
 * on any changes/information from the model.
 */
